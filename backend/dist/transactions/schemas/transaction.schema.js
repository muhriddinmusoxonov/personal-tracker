...
__decorate([
    (0, mongoose_1.Prop)({ required: true, enum: ['personal', 'company'] }),
    __metadata("design:type", String)
], Transaction.prototype, "balanceType", void 0);
__decorate([
    (0, mongoose_1.Prop)({ required: true, enum: ['cash', 'card'] }),
    __metadata("design:type", String)
...
__decorate([
    (0, mongoose_1.Prop)(),
    __metadata("design:type", String)
], Transaction.prototype, "rawExpression", void 0);
__decorate([
    (0, mongoose_1.Prop)(),
    __metadata("design:type", String)
...
], Transaction.prototype, "aiAnalysis", void 0);
__decorate([
...
exports.TransactionSchema.index({ owner: 1, occurredAt: -1 });
exports.TransactionSchema.index({ owner: 1, balanceType: 1, direction: 1 });
exports.TransactionSchema.index({ owner: 1, category: 1 });
